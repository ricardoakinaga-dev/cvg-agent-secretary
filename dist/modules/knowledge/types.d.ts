 ...
 */
export type KnowledgeCategory = 'faq' | 'policy' | 'procedure' | 'service' | 'orientation';
/**
 * Document status in approval workflow
 */
export type KnowledgeDocumentStatus = 'draft' | 'pending_review' | 'approved' | 'published' | 'rejected';
/**
 * Document source
 */
export type KnowledgeSource = 'telegram' | 'manual' | 'imported';
/**
 ...
 */
export type FallbackType = 'no_knowledge' | 'low_confidence' | 'clarification';
/**
